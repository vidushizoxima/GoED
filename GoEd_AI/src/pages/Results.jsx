...
const stats = [
  { num: '98%', label: 'Contact rate (was 40%)', color: 'var(--teal)' },
      ...
      <section style={{ padding: '96px 0' }}>
        <div className="container">
          <div className="section-header">
            ...
            <p className="section-subtitle">How GoEd AI transformed admissions from reactive manual follow-up to an AI-first engine with 98% contact rate.</p>
          </div>
          ...
          <div style={{ maxWidth: 800, margin: '0 auto' }}>
            ...
            <p style={{ fontSize: 16, color: 'var(--gray-600)', lineHeight: 1.7, marginBottom: 12 }}>Contact rate jumped from 40% to 98%. Conversions improved 2.4×. Cost per enrolled student dropped 41%. The social media chat response was described as a &ldquo;wow moment&rdquo; by the Director — specifically Facebook and Instagram DM response speed.</p>
            <p style={{ fontSize: 16, color: 'var(--gray-600)', lineHeight: 1.7 }}>GoEd AI didn&rsquo;t replace the counsellors. It made them 2.4× more effective — and gave the Director complete visibility for the first time in the institution&rsquo;s history.</p>
          </div>
        </div>
      </section>
